...
//				System.out.printf("%d results in total\n", extractor.getTotalResultsNum());
	...
	public static void test_SmallDict_FilterOn() {
		ArrayList<String> aqlModules = new ArrayList<>();
		aqlModules.add("SymptomDict");
	...
	public static void test_SmallDict_FilterOff() {
		ArrayList<String> aqlModules = new ArrayList<>();
		aqlModules.add("SymptomDict");
...
//		testFiles.add("1M");
	...
	public static void test_LargeDict_FilterOn() {
		ArrayList<String> aqlModules = new ArrayList<>();
		aqlModules.add("DrugDict");
...
//		testFiles.add("1M");
	...
	public static void test_LargeDict_FilterOff() {
		ArrayList<String> aqlModules = new ArrayList<>();
		aqlModules.add("DrugDict");
